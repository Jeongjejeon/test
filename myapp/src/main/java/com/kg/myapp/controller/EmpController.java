...
public class EmpController {
	...
	@GetMapping(value="/emp/listdept")
	public String empList(@RequestParam(value="deptId")int deptId, Model model) {
		model.addAttribute("empList", empService.selectDepartment(deptId));
		return "emp/listdept";
	}
	
	@GetMapping(value="/emp/listname")
	public String empList(@RequestParam(value="nameId")String nameId, Model model) {
		model.addAttribute("empList",empService.selectName(nameId));
		return "emp/listname";
	}
