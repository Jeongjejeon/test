...
import com.kg.myapp.HelloController;
...
public class EmpMain {
	...
	public static void main(String[] args) {
		...
		/*
		 * System.out.println(empService.selectEmployee(100)); List<EmpVO> empList =
		 * empService.selectAllEmployees(); for(EmpVO emp : empList) {
		 ...
		 * System.out.println(empService.getAllManagerId()); con.close();
		 */
